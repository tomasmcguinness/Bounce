...
namespace Bounce.WindowsPhone
{
  ...
  public class Game1 : Microsoft.Xna.Framework.Game
  {
    ...
    protected override void Update(GameTime gameTime)
    {
      ...
      map.Update((int)Math.Min((float)gameTime.ElapsedGameTime.TotalMilliseconds * 0.001f, (1f / 30f)));

      //var newPosition = BoxBody.Position - screenCenter;

      //camera.X = (int)ConvertUnits.ToDisplayUnits(BoxBody.Position.X - 25);
      //camera.Y = (int)ConvertUnits.ToDisplayUnits(BoxBody.Position.Y - 25);

      //Camera.Position = new Vector2(ConvertUnits.ToDisplayUnits(BoxBody.Position.X - 25), ConvertUnits.ToDisplayUnits(BoxBody.Position.Y - 25));
    ...
    protected override void Draw(GameTime gameTime)
    {
      ...
      spriteBatch.Begin(SpriteSortMode.BackToFront, BlendState.AlphaBlend, SamplerState.AnisotropicWrap, DepthStencilState.Default, RasterizerState.CullNone, null, Camera2D.View);
      ...
      //{
      //  spriteBatch.Draw(MyTexture, new Microsoft.Xna.Framework.Rectangle((int)ConvertUnits.ToDisplayUnits(body.Position).X + (int)ConvertUnits.ToDisplayUnits(BoxBody.Position.X), (int)ConvertUnits.ToDisplayUnits(body.Position.Y) + (int)ConvertUnits.ToDisplayUnits(BoxBody.Position.Y), 16, 16), null, Color.Gray, body.Rotation, new Vector2(0, 0), SpriteEffects.None, 0);
      //}
