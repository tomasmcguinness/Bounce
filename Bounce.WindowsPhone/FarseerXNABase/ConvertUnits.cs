...
namespace FarseerXNABase
{
    ...
    {
        private static float _displayUnitsToSimUnitsRatio = 9.6f;       //9.6 is the ratio when you are in landscape mode, in portrait mode it should be 16. Calculated somehow, don't ask how.
