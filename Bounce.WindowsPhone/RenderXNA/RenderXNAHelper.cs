...
namespace RenderXNA
{
    ...
    /// </summary>
    public class RenderXNAHelper : DebugView, IDisposable
    {
        //Drawing
        ...
        private Dictionary<string, List<Fixture>> _texturedObjects;
        ...
        public RenderXNAHelper(World world)
            : base(world)
        {
        ...
        private void AddFixture(Fixture fixture)
        {
            ...
            {
                if (fixture.UserData is RenderMaterial)
                {
                    RenderMaterial tempMat = (RenderMaterial)fixture.UserData;
                    //Vinit Commented Out
                    ...
                    if (!_texturedObjects.ContainsKey(tempMat.TextureName))
                    {
                        _texturedObjects[tempMat.TextureName] = new List<Fixture>();
                    }
                    _texturedObjects[tempMat.TextureName].Add(fixture);
                }
            }
        }
        ...
        private void RemoveFixture(Fixture fixture)
        {
            ...
            //}
            foreach (KeyValuePair<string, List<Fixture>> p in _texturedObjects)
            {
                p.Value.Remove(fixture);
            }
        }
        ...
        private void DrawTexturedShapes(ref Matrix projection)
        {
            ...
            foreach (KeyValuePair<string, List<Fixture>> pair in _texturedObjects)
            {
                ...
                if (_fillCount > 0)
                {
                    ...
                    _texturedEffect.Texture = Materials.GetMaterial(pair.Key);
        ...
        private void DrawTexturedPolygon(Fixture fixture)
        {
            ...
            fixture.Body.GetTransform(out xf);
            PolygonShape poly = (PolygonShape)fixture.Shape;
            RenderMaterial material = (RenderMaterial)fixture.UserData;
            ...
            for (int i = 1; i < count - 1; i++)
            {
                ...
                // outline
                //DrawTexturedLine(v1, v2); //Vinit Commented out
            }
        ...
        public void LoadContent(GraphicsDevice device, ContentManager content)
        {
            ...
            _texturedObjects = new Dictionary<string, List<Fixture>>();
